...
class Tokenizer:
    ...
    def from_train_config(cls, config: TrainConfig) -> Tokenizer:
        ...
        if config.model.vocab_size != tokenizer.vocab_size:
            raise OLMoConfigurationError(f"vocab size mismatch between config and tokenizer, config vocab size: {config.model.vocab_size}, tokenizer vocab size: {tokenizer.vocab_size}")
        return tokenizer
    ...
    def from_checkpoint(cls, checkpoint_dir: PathOrStr) -> Tokenizer:
        ...
        if model_config.vocab_size != tokenizer.vocab_size:
            raise OLMoConfigurationError(f"vocab size mismatch between config and tokenizer, config vocab size: {model_config.vocab_size}, tokenizer vocab size: {tokenizer.vocab_size}")
        return tokenizer
