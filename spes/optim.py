...
try:
    ...
    from .custom_sparse_glu_impl import CustomSparseGLU
    ...
    for mn, m in model.named_modules():
        for pn, p in m.named_parameters():
            ...
            if pn.endswith("bias"):
                ...
                decay.add(fpn)
            elif megablocks_available and ('expert_w1' in pn or 'expert_w2' in pn or 'expert_v1') and isinstance(m, CustomSparseGLU):
                decay.add(fpn)
